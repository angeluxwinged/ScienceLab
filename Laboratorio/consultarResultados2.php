		...
		<div class="containerCover">
			<div class="cover">
					...
					<form class="consulta" method="POST">
						<a class="botonCambiar" href="consultarResultados.php">CAMBIAR A CONSULTAR RESULTADOS COVID</a> 
						<h1>Consultar resultados THC</h1>
						...
						<div class="consultaInfo">
							<input type="text" name="escConsultaTHC">
						</div>
